...
```bash
git clone git@github.com:htmlacademy-php/doingsdone.git
```

Адрес в команде нужно заменить на тот, что вы скопировали. Теперь в папке `doingsdone` лежит ваш проект.
...
git remote add academy git@github.com:htmlacademy-php/279077-doingsdone.git
```
